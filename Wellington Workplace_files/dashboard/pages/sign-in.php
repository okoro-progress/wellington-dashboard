        ...
        <div class="row">
          <div class="col-lg-4 col-md-8 col-12 mx-auto">
            <div class="card z-index-0 fadeIn3 fadeInBottom">
              ...
              <div class="card-body">
                <form role="form" class="text-start" method="post" action="signin.inc.php">
                  ...
                  <div class="text-center"> 
                    <input type="submit" name="submit" value="Sign in" class="btn bg-gradient-info w-100 my-4 mb-2">
                  </div>
